...
onMounted(() => {
    ...
    if (savedEmail) {
        loginUser.value.userId = savedEmail
...
const login = async () => {
    if (rememberEmail.value) {
        localStorage.setItem('rememberedEmail', loginUser.value.userId)
    } else {
                        ...
                        <div class="card-body p-5 text-center">
                            <form @submit.prevent="login">
                                ...
                                <button data-mdb-button-init data-mdb-ripple-init
                                    class="btn btn-lg btn-block btn-primary" style="background-color: white;"
                                    type="submit">
                                    <img src="../assets/login/google_icon.png" style="width: 25px;">Sign in with google
                                </button>
                                <br />
                                <button data-mdb-button-init data-mdb-ripple-init
                                    class="btn btn-lg btn-block btn-primary mb-2" style="background-color: white;"
                                    type="submit">
